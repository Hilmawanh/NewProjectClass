...
//   totalHargaCheckout=()=>{
//     var pesananuser=this.state.datacart
//     for(var i=0;i<pesananuser.length;i++){
//         this.state.hargacheckout+=pesananuser[i].totalharga
//     }
...
//             <td style={{width:120}}>Rp.{val.totalharga}</td>
//             <td style={{ width: 60 }}>
//               <button
...
//   deleteCart = () => {
//     Axios.delete(`${APIURL}orders?/${this.state.deletedatacart.id}`).then(
//       res => {
//         Axios.delete(``);
//       }
//     );
