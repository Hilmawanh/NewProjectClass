  ...
  render() {
    ...
    if (this.state.belitiketok) {
      return (
        ...
        />
      ); // ini nge redirect dan juga membawa data this.state.datadetailfilm(object dari film yg di klik)
    }
    return (
      <div>
        {/* =========== modal trailer==== */}
        ...
        >
          <ModalBody>Antum belum login</ModalBody>
          <ModalFooter>
        ...
        <Fade>
          <center>
            <Alert
              ...
              isOpen={this.state.ProteksiAdmin}
              toggle={() => this.setState({ ProteksiAdmin: false })}
            >
              Beli tiket hanya untuk user ya :)
            </Alert>
          </center>
        </Fade>
